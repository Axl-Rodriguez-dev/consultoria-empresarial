...
function createServiceCard(service) {
  ...
  badge.innerHTML = makeBadgeSVG(toRoman(getServiceNumber(service.id)));
  ...
  desc.textContent = service.shortDescription;
...
function renderServices(list) {
  ...
  list.forEach(service => grid.appendChild(createServiceCard(service)));
}
